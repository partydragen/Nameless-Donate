                                        ...
                                        {foreach from=$ALL_PAYMENTS item=payment}
                                            <tr>
                                                ...
                                                {if !empty($payment.user_avatar)}
                                                    <a href="{$payment.user_link}" style="{$payment.user_style}"><img src="{$payment.user_avatar}" class="rounded" style="max-width:32px;max-height:32px;" alt="{$payment.username}" /> {$payment.username}</a>
                                                {else}
